...
\"\n\
checkout_executable TCLSH \"/home/sujan/Documents/AdvancedComputerNetworks/ns-allinone-2.35/bin/tclsh8.5\" tclsh \"\\\n\
When configured, ns found the right version of tclsh in\\\n\
/home/sujan/Documents/AdvancedComputerNetworks/ns-allinone-2.35/bin/tclsh8.5\n\
but it doesn't seem to be there anymore, so\\\n\
...
Agent/TCP set d2tcp_deadline_ 0;\n\
Agent/TCP set d2tcp_total_bytes_ 0;\n\
Agent/TCP set d2tcp_gamma_ 0.0;\n\
\n\
\n\
\n\
